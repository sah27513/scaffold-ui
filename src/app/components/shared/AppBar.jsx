...
import { Tooltip, AppBar as MAppBar, Toolbar, Badge, IconButton, Avatar } from '@material-ui/core';
...
import { Search } from 'app/components/shared';
...
export const AppBar = props => {
  ...
  return (
    <div className={classes.root}>
      <MAppBar position="relative" className={classes.privateAppBar}>
        <Toolbar variant="dense">
          ...
          <IconButton
            ...
            aria-label="help"
            color="inherit"
            onClick={() => props.handleDrawerOpen({ type: 'help', drawer: 'right' })}
          >
          ...
          <IconButton
            ...
            aria-label={label}
            color="inherit"
            onClick={() => props.handleDrawerOpen({ type: 'notifications', drawer: 'right' })}
          >
